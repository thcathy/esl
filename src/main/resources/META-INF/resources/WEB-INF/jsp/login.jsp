...
<s:eval expression="@environment.getProperty('static.server.host')" var="staticHost" />
<!DOCTYPE html>
<html>
<head>
    ...
    <script src="${staticHost}/js/jquery.growl.js" type="text/javascript"></script>
</head>
<body style="background-image: url(${staticHost}/images/main_bg.jpg);
...
<nav class="w3-theme">
    <a href="/index.jsf" class="w3-padding"><img src="${staticHost}/images/graphic/logo.png" style="max-width: 141px; width:100%" alt="logo"/></a>
...
<div class="container">
    ...
    <script type="text/javascript">
        var options = {
            ...
            closable: false,
            auth: {
                redirectUrl: '${fn:replace(pageContext.request.requestURL, pageContext.request.requestURI, '')}/callback?redirect=${reDirectUrl}',
                responseType: 'code',
                params: {
                    state: '${state}',
